 ...
 * @author gimmi
 */
@WebServlet(urlPatterns={"/newAchi"})
public class NewAchiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/newAchiView.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Owners.insertAchievement(conn, achi);
            response.sendRedirect("/GamingPlatform/gameOwner?idG="+idG);
        } catch (SQLException ex) {
            Logger.getLogger(NewAchiServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
